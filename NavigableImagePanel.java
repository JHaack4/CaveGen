// https://github.com/imagej/envisaje/blob/master/PaintUI/src/main/java/imagej/envisaje/paintui/NavigableImagePanel.java
...
public class NavigableImagePanel extends JComponent { // Panel {
    ...
    static boolean navigationImageEnabled = true;
