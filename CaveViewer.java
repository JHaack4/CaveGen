...
public class CaveViewer {
    ...
    String argString2 = "AdditionalArgs,_;Region,dropdown,US|JPN|PAL,x;Judge,dropdown,|attk|pod|at|key|cmat|score|colossal|alcove,x;JudgeFilter,_;ConsecutiveSeeds,#";
    String argString3 = "NoImages,NoStats,NoPrints,NoWayPointGraph,ChallengeMode,StoryMode,DrawSpawnPoints,DrawAngles,DrawScores,DrawEnemyScores,DrawDoorLinks,DrawAllScores,DrawDoorIds,DrawWayPoints,DrawAllWayPoints,DrawTreasurePaths,DrawTreasureGauge,DrawHoleProbs,DrawNoPlants,DrawNoObjects,DrawNoWaterBox,DrawNoBuriedItems,DrawNoItems,DrawNoTekis,DrawNoHoles,Pretty,QuickGlance,CaveInfoReport,Aggregator,AggRooms,WriteMemo,ReadMemo,251";
